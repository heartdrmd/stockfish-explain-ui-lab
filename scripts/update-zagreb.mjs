...
if (!existsSync(resolve(source, 'dist/index.html')) || !existsSync(resolve(source, 'bundled/saved-view.mjs')) || !existsSync(resolve(source, 'bundled/clock-control.mjs')) || !existsSync(resolve(source, 'bundled/clock-hardware.mjs')))
