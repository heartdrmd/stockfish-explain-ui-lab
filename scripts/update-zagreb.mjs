...
if (!['dist/index.html', 'bundled/saved-view.mjs', 'bundled/clock-control.mjs', 'bundled/clock-hardware.mjs', 'bundled/clock-styles.mjs'].every(path => existsSync(resolve(source, path))))
